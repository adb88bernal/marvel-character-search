...
export class MarvelComicsApiService {
  ...
  getMarvelComics(id): Observable<any>{
    let url: string = `https://gateway.marvel.com:443/v1/public/characters/${id}/comics`;
    let apikey: string = '0c3cc99673cc363f4b84181988629b03';
    let private_key:string = '80d5a4b534dfb5b8ddddf8b0451130cba30dca75';
    let hasDigital: string = 'true';
    ...
    params.set('hasDigitalIssue', hasDigital);
